...
| حقيقة المنتج المحدثة: خصومات الأكواد وخصم عيد الميلاد والتوصيل المجاني تتحملها المنصة ولا تُحمّل على التاجر. التاجر يتحمل فقط العروض التي أنشأها، الفلاش سيلز، واستخدام النقاط عندما يخص الاسترداد جزء تاجر نشطًا ويحتوي لقطة صالحة من قاعدة الإدارة. | تمويل الخصومات والتسوية | المالية |
...
حقيقة المنتج المحدثة: خصومات الأكواد وخصم عيد الميلاد والتوصيل المجاني تتحملها المنصة ولا تُحمّل على التاجر. هذه القيم تخصم/تظهر ضد حصة المنصة أو مبلغها المستحق حسب التسوية. التاجر يتحمل فقط العروض التي أنشأها، الفلاش سيلز، واستخدام النقاط عندما يخص الاسترداد جزء تاجر نشطًا ويحتوي لقطة صالحة من قاعدة الإدارة. فاتورة السائق يومية وإجبارية، وصافي المستحق لا ينخفض تحت الصفر.
...
| عمولات التجار والسائقين العامة والخاصة، تسعير التوصيل، الفواتير، تعليمات الدفع. | الفاينانس |
| ضبط عدد المرات المجانية، مدة المرة، التجديد الأسبوعي، وسعر الخطة الأسبوعية بعد المجاني. | الفلاش سيلز |
| إنشاء كوبونات نسبة خصم بحد أقصى. | الكوبونات |
...
خصومات الأكواد وخصم عيد الميلاد والتوصيل المجاني تتحملها المنصة ولا تُحمّل على التاجر. هذه القيم تظهر/تخصم ضد حصة المنصة أو مبلغها المستحق في تقارير الإدارة. استخدام النقاط يتحمله التاجر فقط عندما تفعّل الإدارة استخدام النقاط لهذا التاجر وتحدد قيمة تحويل متفق عليها. الفلاش سيلز والعروض التي أنشأها التاجر تظل مسؤولية التاجر. ممنوع الجمع بين التوصيل المجاني وخصم كود أو خصم عيد ميلاد في نفس الطلب.
...
| خصم نسبة بحد أقصى. | الإدارة | كوبون |
...
| المعنى | الحقل |
| ---: | ---: |
| نسبة تطبق على قيمة المنتجات المؤهلة. | نسبة الخصم |
| أقصى مبلغ بالجنيه يمكن خصمه. | الحد الأقصى |
...
خصومات الأكواد وهدية عيد الميلاد والتوصيل المجاني تظهر للعميل كتوفير تتحمله المنصة، ولا تُخصم من مستحقات التاجر. الطلب يسمح بميزة واحدة فقط من هذه المزايا: لا يمكن جمع خصم الكوبون مع خصم عيد الميلاد، وأي خصم موجب منهما يلغي التوصيل المجاني. إذا أرسل عميل مؤهل لخصم عيد الميلاد كوبونًا موجبًا يرجع الباك اند `ORDER_DISCOUNT_BENEFIT_CONFLICT` وعلى الواجهة إزالة الكوبون للاحتفاظ بخصم عيد الميلاد. خصم استبدال النقاط يظل آلية منفصلة يتحملها التاجر ويمكن أن يعمل مع الميزة المختارة عندما يخص الاسترداد جزء تاجر نشطًا ويحتوي لقطة صالحة من قاعدة الإدارة.

<a id="14-flash-sales"></a>

## 14. الفلاش سيلز

الفلاش سيلز عروض قصيرة المدة ينشئها التاجر، لكن قواعدها تحت تحكم الإدارة. الفلاش سيل بعد المجاني لا يتحاسب بالساعة؛ بعد انتهاء المجاني يستخدم التاجر خطة مدفوعة أسبوعية إذا كانت الإدارة مفعّلاها.

| المعنى | القاعدة |
| ---: | ---: |
| الإدارة تقدر تفتح أو تقفل المرات المجانية بالكامل. | تفعيل المجاني |
...
| النسبة الخاصة بالتاجر إن وجدت، وإلا النسبة العامة للتجار. | نسبة العمولة |
| خصومات الأكواد وخصم عيد الميلاد لا تُحمّل على التاجر، ويتم إظهارها/خصمها من حصة المنصة عند الحاجة للمراجعة. | خصومات ممولة من المنصة |
| العروض التي أنشأها التاجر يتحملها التاجر لأنها تمت بموافقته. | عروض التاجر |
| تكلفة الخطة/الاستخدام المدفوع للفلاش سيل بعد المجاني يتحملها التاجر وتظهر كبند منفصل. | تكلفة الفلاش سيل |
| خصم النقاط يتحمله التاجر فقط إذا كان الاسترداد يخص جزء تاجر نشطًا ويحتوي لقطة صالحة من قاعدة الإدارة. | استخدام النقاط |
| صافي عمولة التاجر + البنود التي يتحملها مثل الفلاش سيل والنقاط، بدون تحميل خصومات الأكواد/عيد الميلاد على التاجر. | إجمالي المستحق |
...
| التوصيل المجاني وخصومات الأكواد وخصم عيد الميلاد تخصم/تظهر ضد حصة المنصة أو مبلغها المستحق، ولا تُحمّل على التاجر. | خصومات ممولة من المنصة |
...
| إجمالي عمولة السائق ناقص الخصومات الممولة من المنصة، ولا يقل عن صفر. | إجمالي المستحق |
...
| عمولة التاجر + البنود التي يتحملها التاجر فقط: عروضه، الفلاش سيلز المدفوع، وخصم النقاط عندما يخص الاسترداد جزء تاجر نشطًا ويحتوي لقطة صالحة من قاعدة الإدارة. | فاتورة التاجر الأسبوعية |
| خصم الأكواد، خصم عيد الميلاد، والتوصيل المجاني تتحملها المنصة ولا تُحمّل على التاجر. | خصومات ممولة من المنصة |
| فاتورة السائق يومية وإجبارية، وتسدد بمحفظة/InstaPay مع إيصال أو كاش في المقر وتسقطها الإدارة. | فاتورة السائق اليومية |
...
هذه اللقطة تلغي أي wording قديم يحمّل خصم الكوبون أو خصم عيد الميلاد على التاجر أو يعتبر فاتورة السائق أسبوعية فقط.
...
2. خصومات الأكواد وخصم عيد الميلاد والتوصيل المجاني تتحملها المنصة ولا تُحمّل على التاجر.
3. التاجر يتحمل فقط ما وافق عليه أو أنشأه: عروض المنتجات، الفلاش سيلز، واستخدام النقاط عندما يخص الاسترداد جزء تاجر نشطًا ويحتوي لقطة صالحة من قاعدة الإدارة.
...
- المنصة تتحمل: التوصيل المجاني، خصم الأكواد، وخصم عيد الميلاد.
- التاجر يتحمل فقط: العروض التي أنشأها، الفلاش سيلز، واستخدام النقاط/الكاش باك عندما تكون مفعلة ومسعّرة من الإدارة.

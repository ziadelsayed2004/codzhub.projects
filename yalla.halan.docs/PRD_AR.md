...
| القيمة | الحقل |
| ---: | ---: |
| نطاق المنتج الحالي المعتمد؛ باك إند Phase 48 وإنشاء المهام وتقدم العميل والكوبونات والـCheckout في Phase 49 مكتملة محليًا، وأساس نطاق توفر التاجر وواجهات Merchant-owner وAdmin في Phase 50 منفذة حتى `backend_291`، بينما التنفيذ المركزي والواجهات والبوابات الحية ما زالت مفتوحة | الحالة |
...
| مزامنة عقد الـUI والباك إند وPostman - ٤ أغسطس ٢٠٢٦ | الإصدار |
| باك إند المساعد/الخبرة-السوشيال/الطوارئ وإنشاء المهام والتقدم والكوبونات والـCheckout وإغلاق Postman ودليل السعة المحلي الآمن مكتمل محليًا؛ مواعيد التاجر وOpen/Closed/Busy وتحكم الأدمن وإغلاق Postman للمرحلة 50 منفذة حتى `backend_293`؛ دليل السعة التمثيلي والواجهات ودليل المزودين/النشر الحي مفتوحة | حالة الإضافات الجديدة |

يلا حالًا هو سوق محلي للتجارة والتوصيل. يقدر العميل يطلب من تاجر واحد أو من أكثر من تاجر في نفس عملية الشراء، حتى الحد الذي تحدده الإدارة. كل تاجر يحضّر الجزء الخاص به فقط، والسائق المعتمد يستلم الأجزاء النشطة ويوصل الطلب للعميل. الإدارة تتحكم في قواعد المنصة: الموافقات، التصنيفات، المناطق، رسوم التوصيل، العمولات، الفواتير، الفلاش سيلز، الكوبونات، نقاط الكاش باك، التقارير، الأمان والدعم. الإضافات المعتمدة تشمل مساعد خدمة عملاء مرتبط بـOpenAI API من قاعدة معرفة معتمدة، ولوحة Top 10 بنقاط خبرة تراكمية ومكافآت مضبوطة لأنشطة Facebook وInstagram، وخياري اتصال منفصلين لطوارئ الدليفري، وشاشة مهام ومكافآت بسعر ٣٥٠ دولار ينشئ الأدمن فيها التارجت والجائزة ويحصل العميل بعد الإكمال على كود شخصي لتوصيل مجاني أو خصم نسبة بحد أقصى بالجنيه. تعديل Phase 50 المعتمد يضيف وقت فتح ووقت قفل واحدين للتاجر مطبقين على الأسبوع كله، وحالات Open وClosed وBusy، وBusy مؤقتًا بمضاعفات 30 دقيقة، وتنبيهًا آمنًا للعميل، وتحكمًا مدققًا من الأدمن. عجلة الحظ مستبعدة من المنتج بقرار المالك لأسباب شرعية.
...
- [الجزء الأول - PRD المنتج](#part-1-product-prd)
  ...
  - [عقد شاشات التاجر والدليفري المسلّمة](#supplied-merchant-and-delivery-ui-contract)
...
## عقد شاشات التاجر والدليفري المسلّمة

الملفان المدمجان `MerchantApp.pdf` و`DeliveryApp.pdf` هما مرجع ترتيب الشاشات المعتمد لتطبيقي التاجر والدليفري، والنسختان العربية والإنجليزية تمثلان نفس الفلو. الـUI يحدد الترتيب والنص الظاهر، بينما Schemas الباك إند النشطة تحدد حقول الطلب القابلة للتنفيذ والحالات والصلاحيات والأخطاء. شاشة Business Hours رقم 104 تعرض وقت بداية ووقت نهاية فقط؛ لذلك يرسل التطبيق هذين الوقتين ليطبقهما السيرفر على الأسبوع كله بتوقيت `Africa/Cairo`، بدون صفوف لكل يوم وبدون رقم نسخة availability من التطبيق.

| الواجهة | ترتيب الشاشات المسلّم | عقد الباك إند وPostman القابل للتنفيذ |
|---|---|---|
| تسجيل وجلسة التاجر | 01–06 تسجيل وWhatsApp OTP ومستندات وانتظار المراجعة؛ 07–11 دخول واستعادة كلمة السر وحالة الحظر | Shared Auth: قنوات/إرسال/تأكيد OTP، رفع مستندات التسجيل الخاصة، تسجيل التاجر، الدخول والاستعادة وRefresh/Logout. الانتظار والحظر حالتان ناتجتان من الرد وليستا Endpoint تعديل منفصلًا. |
| طلبات التاجر | 12–17 New/Preparing/History وتعديل التجهيز للطلب الكبير وحالتي Offline/Suspended | الطلبات الواردة والتاريخ والقبول/الرفض والريسيت والحساب والتوفر الصريح. التجهيز يثبت وقت القبول، ولا تظهر أفعال prep/start/ready الملغاة. |
| كتالوج التاجر | 18–29 المنتجات والخيارات والأحجام والعروض والتعديل والتفعيل والحذف | Product CRUD وstock/bulk toggle والتصنيفات المعينة والرفع وPayloads كاملة وصحيحة للأحجام والعروض. |
| التحليلات والعروض | 30–32 مؤشرات المنتج؛ 33–36 الفلاش سيلز | Product KPIs وFlash Deals، مع بقاء الأهلية والاشتراك/الدفع تحت تحكم السيرفر. |
| داشبورد وإعدادات التاجر | 37–40 المؤشرات؛ 41 الإشعارات؛ 42 الإعدادات؛ 43 المساعدة؛ 44 الخصوصية | KPIs والإشعارات وقراءة البروفايل/التصنيفات وSupport threads/messages. شاشة الخصوصية محتوى ثابت ولا نختلق لها API. |
| مالية التاجر | 45–47 الفاتورة ورفع الإيصال وإرسال الدفع | قائمة فواتير التاجر وتعليمات الدفع والرفع الخاص وإرسال إثبات الفاتورة. |
| إضافات توفر التاجر | 96–103 Open/Busy/Closed؛ 104–105 Business Hours | `GET /merchant/availability` و`PUT /merchant/availability/state` بشكل idempotent و`PUT /merchant/availability/schedule` بالحقول `{ opensAt, closesAt }`. الحفظ يفعل المواعيد للأسبوع كله. مدة Busy من 30 إلى 720 دقيقة بخطوات 30 دقيقة. التطبيق لا يرسل version. `PATCH /merchant/toggle-active` توافق قديم فقط ولا يُربط بالشاشات الحالية. |
| تسجيل وجلسة الدليفري | 01–06 تسجيل وOTP ومستندات المركبة والشخص وانتظار المراجعة؛ 07–11 دخول واستعادة وحظر | Shared Auth للسائق مع المستندات الخاصة والتسجيل والدخول والاستعادة. الانتظار والحظر حالتان من رد السيرفر. |
| شغل وطلب الدليفري | 12–13 الطلبات المتاحة وتفضيلات العمل؛ 14–16 الملاحة ودفع التاجر والاستلام وتحصيل العميل والتسليم | Dashboard/available orders والقبول/الرفض والحالة والمنطقة وauto-nearest ومسار/قواعد التسليم/الموقع/الخطوات وتأكيد قيمة دفع التاجر بدقة. |
| تواصل وحالة الدليفري | 17–19 الشات والتنبيه وCooldown؛ 20–21 Offline/Suspended؛ 22 الإشعارات | Chat وalert availability/send/acknowledge/dismiss وحالة السائق وقراءة الإشعارات. |
| إعدادات ودعم الدليفري | 23 الإعدادات؛ 24 تعديل البروفايل والمنطقة؛ 25 الدعم | بروفايل السائق والمنطقة وتفضيلات الإشعارات وSupport threads/messages المملوكة للحساب. |
| داشبورد ومالية الدليفري | 26 الداشبورد؛ 27 معلومات التقييم؛ 28 الطلبات؛ 29 الأرباح؛ 30–32 دفع الفاتورة | Dashboard/history والفواتير وتعليمات الدفع ورفع الإيصال وإرساله. شاشة 27 معلومات فقط، ولا يوجد فعل إرسال تقييم من السائق. |
| المساعدة والخصوصية | 33 مركز المساعدة؛ 34 الخصوصية | المساعدة تستخدم عقد Support، والخصوصية محتوى ثابت بلا API مختلق. |

فجوة عقد مفتوحة ومعروفة: شاشتا الدليفري 04–05 تعرض وجهي البطاقة ورخصة القيادة وترخيص المركبة، وselfie أمامية/جانبية، وحدًا أقصى ثلاث صور للمركبة. الباك إند الحالي يقبل `nationalIdFile` و`selfieFile` ملفًا واحدًا لكل منهما، و`drivingLicenseFile`/`vehicleRegistrationFile` اختياريين كملف واحد، و`vehiclePhotoFiles` بلا حد أقصى. يظل Postman النشط موثقًا للحقيقة الحالية حتى تنفذ وتهاجر Step `backend_294_driver_verification_document_ui_parity` العقد متعدد الجوانب.

أي شاشة مسلّمة بلا Frontend إنتاجي تظل مهمة تنفيذ وUAT مفتوحة. وأي فعل ظاهر بلا عقد Backend نشط يجب أن يتحول إلى Step جديدة داخل Agent Pack قبل التنفيذ؛ لا يُغطى بطلب Postman وهمي أو رد Frontend ثابت.
...
| السيرفر يحسب الحالة الفعلية بتوقيت `Africa/Cairo`؛ حالة الحساب أو قفل الأدمن أو Busy الفعال أو Closed اليدوي أو الخروج عن المواعيد يمنع كل Preview/Create/Materialization لطلب جديد، بينما الطلبات المقبولة تستمر. عمليات الحالة idempotent ولا تحتاج version من التطبيق. | التاجر يختار Open أو Closed أو Busy مؤقتًا ويضبط وقت فتح ووقت قفل واحدين للأسبوع كله من الإعدادات. Busy يبدأ من 30 دقيقة وبمضاعفات 30. | التوفر |
...
### قواعد مواعيد العمل وBusy للتاجر

| المطلوب | القاعدة |
| ---: | ---: |
| وقت `opensAt` ووقت `closesAt` واحدان بتوقيت `Africa/Cairo` يطبقهما السيرفر بنفس الصورة على أيام الأسبوع السبعة. يمكن أن يعبر الوقت منتصف الليل عندما يكون وقت القفل أسبق من وقت الفتح. يظل التاجر القديم على السلوك اليدوي حتى التفعيل. | Business Hours |
| يلغي Busy المؤقت ويطلب الاستقبال العادي، لكنه لا يتجاوز خروج الموعد أو قفل الأدمن أو عدم صلاحية الحساب. | Open |
| يوقف الطلبات الجديدة حتى يختار التاجر Open وتسمح القواعد الأعلى أولوية. | Closed |
| يوقف الطلبات الجديدة من 30 إلى 720 دقيقة بمضاعفات 30، ويعرض وقت العودة المتوقع، وينتهي تلقائيًا حسب وقت السيرفر. | Busy |
| الأدمن المصرح له يعدل الجدول والحالة وBusy ويطبق/يلغي قفلًا إداريًا مع سبب وسجل ثابت؛ التاجر لا يلغي قفل الأدمن. | تحكم الأدمن |
| Busy والغلق بالمواعيد يعرضان للعميل حالة آمنة ووقت العودة/الفتح عند معرفته، بدون إظهار سبب الأدمن الداخلي. | رسالة العميل |
| إخفاء التاجر من الكتالوج ليس حماية. Preview وCreate وتعديل/Retry المسودة وCheckout والطلب الأسبوعي تفحص كل تاجر قبل أي آثار جانبية، وفشل الطلب متعدد التجار يكون كاملًا. | الإنفاذ |
...
| ---: | ---: |
| متابعة مؤشرات السوق والطلبات المتأخرة والسائقين الأونلاين والتجار مقسمين إلى Open وBusy وScheduled Closed وManual Closed وAdmin Closed وAccount Unavailable. | المراقبة |
...
| عرض وإيقاف/تفعيل العملاء والتجار والسائقين. قائمة التاجر تعرض مؤشرات التجهيز والحالة الفعلية والانتقال/الفتح التالي وBusy-until وفلاتر الحالة، ويعدل الموظف المصرح له الجدول وOpen/Closed/Busy أو قفل الأدمن المدقق. | الحسابات |
...
شاشة المهام والمكافآت إضافة معتمدة بسعر **٣٥٠ دولار** تخص تطبيق العميل ولوحة الأدمن. تم تنفيذ Domain الـRevision ودورة الإدارة، وتقدم العميل من الطلبات المسلّمة، وإصدار الكوبون الشخصي، ودورة الحجز والاستخدام والاسترجاع داخل Checkout والتسوية، وإحدى عشرة API بصلاحية أو ملكية صريحة محليًا، مع Harness سعة محلي آمن ومحدود. التحليلات ودليل السعة التمثيلي وكل الواجهات ما زالت مفتوحة.
...
| مواعيد أسبوعية بتوقيت القاهرة، Open/Closed/Busy، انتهاء/إلغاء Busy، قفل وسجل الأدمن، رسالة وقت الفتح للعميل، معالجة السلة القديمة، ومنع Preview/Create/Weekly بصورة Fail-closed. | توفر التاجر |
...
| جدول أسبوعي بإصدار، حالة يدوية، Busy مؤقت، قفل أدمن، حالة فعلية، Audit، ومنع الطلب الجديد. | توفر التاجر |
...
| متجره، تصنيفاته، منتجاته، أجزاء طلباته، فواتيره، ومواعيده وOpen/Closed/Busy الخاصة به؛ ولا يلغي قفل توفر من الأدمن. | التاجر |
...
إدارة قاعدة معرفة المساعد، وإعداد مكافآت الأنشطة الاجتماعية، ومراجعة قدرة المزود والاستثناءات اليدوية المسموحة، وإنشاء/دعم `tasks_rewards`، وتعديل جدول/حالة/Busy/قفل توفر التاجر بصلاحية `merchant_availability`، وضبط أرقام الطوارئ تحتاج أقسام/صلاحيات إدارية صريحة وسجل تدقيق. صلاحية قراءة `accounts` وحدها لا تسمح بتعديل توفر التاجر. موظف الدعم يرى المحادثة المحولة والحد الأدنى اللازم لخدمة العميل، ولا يحصل المساعد نفسه على أي صلاحيات تشغيلية.
...
20. كل Preview/Create/Edit/Retry/Checkout وتفعيل طلب أسبوعي يعيد فحص الحالة الفعلية لكل تاجر حسب وقت السيرفر. لو أي جزء غير متاح يفشل الإنشاء كله قبل حجز أي خصم/نقاط أو آثار جانبية، بينما الطلب المقبول سابقًا يستمر.
...
| وقت فتح ووقت قفل واحدان بتوقيت القاهرة للأسبوع كله، وOpen/Closed/Busy بشكل idempotent بدون version من التطبيق، والحالة الفعلية، وقفل وسجل الأدمن، وBadges ووقت الفتح للعميل، وترحيل Toggle القديم، ومنع Payload مباشر/سلة قديمة/طلب متعدد التجار/طلب أسبوعي وعدم استهلاك أي Benefit عند الرفض. النسخة الداخلية والتدقيق مسؤولية السيرفر. الباك إند وPostman منفذان، بينما سورس الواجهة ودليل UAT ما زالا مفتوحين. | توفر التاجر |
...
| دورة الأدمن والـRevision، تقدم الطلبات المسلّمة، قراءة العميل لنفسه، إصدار كود شخصي مرة واحدة، فحص/حجز/استخدام/استرجاع Checkout، ولقطات التمويل والتسوية وإغلاق Postman والأمان وHarness السعة المحلي الآمن فعالة محليًا. التحليلات ودليل السعة التمثيلي والواجهة ما زالت مفتوحة. | المهام والمكافآت |
...
- Routes المساعد/الخبرة-السوشيال/الطوارئ في Phase 48 وإحدى عشرة Route للمهام والمكافآت في Phase 49 منفذة محليًا وموجودة في الـInventory وممثلة في مجموعات Postman النشطة الخاصة بالأدوار وAll-UI: ثمانية للإدارة، واثنتان لتقدم العميل، وواحدة لكوبوناته. التحليلات ليست Route فعالة بعد.
- دومين مواعيد التاجر وOpen/Closed/Busy وتحكم الأدمن والترحيل المتوافق وواجهات Merchant-owner وAdmin والتنفيذ المركزي وطلبات Postman النشطة في Phase 50 منفذة حتى `backend_293`. الـBoolean/Toggle الحالي إسقاط توافق فقط؛ شاشات التاجر المرفوعة 96–105 مرتبطة بالخطوات `merchant_052`–`merchant_054`، بينما سورس الواجهة ودليل المعاملات الحية ما زالا مفتوحين.
...
> Phase 50 truth update (2026-08-04): the Merchant availability domain,
> Merchant-owner/Admin APIs, and central catalog/order/weekly enforcement are
> implemented through `backend_293`. Active Postman/security assurance is locally
> closed; frontend surfaces and Replica Set/live production evidence remain open.

> تحديث Phase 50 (2026-08-04): تم إغلاق أساس توفر التاجر، واجهات Merchant-owner وAdmin،
> التقييم المركزي لمنع الطلبات الجديدة، ودليل Postman والأمان المحلي عبر `backend_293`.
> ما زالت واجهات Frontend، ودليل Replica Set الحي، ودليل السعة التمثيلي، والمزودون، والاستعداد الإنتاجي مفتوحة؛ أما Harness السعة المحلي الآمن فمتاح دون ادعاء قبول إنتاجي.
